...
This repository contains all reference soil analysis and spectral data data, metadata, code and text to reproduce the reference models and the manuscript for
